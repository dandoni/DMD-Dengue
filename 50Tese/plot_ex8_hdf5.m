...
tex = latex_add_fig(tex,"Dado Obtido","ex8_dado");
clf                                    
...
tex = latex_add_fig(tex,"Parte Real", "ex8_rec");
clf    
...
axis([-8,8,0,1])
plot_axis_setup2()
tex = latex_add_fig(tex,"Freq1","ex8_freq1");
clf
...
axis([-8,8,0,1])
plot_axis_setup2()
tex = latex_add_fig(tex,"Freq2","ex8_freq2");
clf


plot(t(50:150),X(50:150))
plot_axis_setup();
tex = latex_add_fig(tex,"dado meia","ex8_dado_meia",'box', 'on');
clf
...
tex = latex_add_fig(tex,"dado meia 2","ex8_dado_meia2",'box', 'on');
clf
