...
function tex = latex_add_fig_png( tex, fig_title, fig_name )

% Save figure as png file and add it to LaTeX file
%
% Usage: tex = latex_add_fig_png( tex, fig_title, fig_name )
%
  ...
  fig_file = [ tex.figsdir '/' fig_name '.png' ];

  try


    print( fig_file, '-dpng', '-r900' )
