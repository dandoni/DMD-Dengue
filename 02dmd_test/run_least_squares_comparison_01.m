...
function run_least_squares_comparison_01

run '../startup'
close all

  % Presentation information
  latexdir = 'latex_least_squares_comparison_01';
  filename = 'least_squares_comparison_01.tex'; 
  ptitle   = 'DMD Least Squares Comparison -- 01'; 
...
function D = commpute_X( N_places, N_snaps )
  ...
  D.X(:,1) = 1 - linspace(-1,1,N_places).^2;
