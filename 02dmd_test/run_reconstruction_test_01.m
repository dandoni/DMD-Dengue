...
function run_reconstruction_test_01

run '../startup'
close all

  % Presentation information
  latexdir = 'latex_reconstruction_test_01';
  filename = 'reconstruction_test_01.tex'; 
  ptitle   = 'DMD Reconstruction Test -- 01'; 
...
%------------------------------------------------------------------------------%
  ...
  content = [ content '\item $x_1$ is a smooth function' endline(2) ];
