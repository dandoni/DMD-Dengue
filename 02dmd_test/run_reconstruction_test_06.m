...
function run_reconstruction_test_06

run '../startup'
close all

  % Presentation information
  latexdir = 'latex_reconstruction_test_06';
  filename = 'reconstruction_test_06.tex'; 
  ptitle   = 'DMD Reconstruction Test -- 06'; 
...
%------------------------------------------------------------------------------%
  ...
  content = [ 'Random senoids' endline(2) ];
