...
function run_reconstruction_test_09

run '../startup'
close all

  % Presentation information
  latexdir = 'latex_reconstruction_test_09';
  filename = 'reconstruction_test_09.tex'; 
  ptitle   = 'DMD Reconstruction Test -- 09'; 
...
%------------------------------------------------------------------------------%
  ...
  content = [ 'Senoidal function on space and time' endline(2) ];
  content = [ content '\[ X = \sin( a x ) \sum b_i \cos( f_i t )\]' endline(2) ];
